                        ...
                        <form wire:submit.prevent="update" class="form">
                            <div class="row g-9">
                                ...
                                <div class="col-md-6 fv-row">
                                    ...
                                    <input type="text" wire:model="name_ar" class="form-control" dir="rtl">
                                ...
                                <div class="col-md-4 fv-row">
                                    ...
                                    <input type="number" step="0.01" wire:model="discount_percentage" class="form-control">
                            ...
                            <div class="d-flex justify-content-end gap-2 mt-10">
                                ...
                                <button type="submit" class="btn btn-base" wire:loading.attr="disabled">
                                    <span wire:loading.remove>Update Tier</span>
                                    <span wire:loading>
                                        Please wait...

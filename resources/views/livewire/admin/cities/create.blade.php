        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">{{($this->eId)?'Edit':'Add New'}} City</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                        ...
                        <form id="kt_modal_new_target_form" enctype="multipart/form-data"  method="POST" class="form fv-plugins-bootstrap5 fv-plugins-framework" wire:submit.prevent="store()">
							...
							<div class="row g-9 my-3">
                                ...
                                <div class="col-md-6 fv-row fv-plugins-icon-container">
                                    ...
                                    <input type="text" class="form-control form-control-solid" placeholder="Enter City Name" wire:model="name" >
                                    @error('name') <span class="text-danger">{{$message}}</span> @enderror
                                </div>
                                <div class="col-md-6 fv-row fv-plugins-icon-container">
									<label class="required fs-6 fw-semibold mb-2"> Name Arabic</label>
                                    <input type="text" class="form-control form-control-solid" placeholder="Enter City Name Arabic" wire:model="name_ar" >
                         ...
                         <div class="row g-9 my-3">
							...
							<!--begin::Actions-->
							<div class=""> 
								<a href="{{ url('admin/cities') }}"  id="kt_modal_new_target_cancel" class="btn btn-light me-3">Back</a>

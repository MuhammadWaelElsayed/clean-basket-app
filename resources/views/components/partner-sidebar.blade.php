    ...
    <div class="app-sidebar-menu overflow-hidden flex-column-fluid">
        ...
        <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_menu" data-kt-scroll-offset="5px" data-kt-scroll-save-state="true">
            ...
            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
                ...
                <div class="menu-item "> 
                    <!--begin:Menu link-->
                    <a class="menu-link  @yield('dashboardActive')" wire:navigate href="{{ route('partner.dashboard')}}">
                ...
                <!--end:Menu item-->
                <div class="menu-item">
                    <a class="menu-link  @yield('ordersActive')" wire:navigate href="{{ route('partner.orders') }}" >
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-2">
                ...
                <div class="menu-item">
                    <a class="menu-link  @yield('requestsActive')" wire:navigate href="{{ route('partner.requests') }}" >
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="menu-item">
                    <a class="menu-link @yield('reportsActive')" wire:navigate href="{{ route('partner.reports') }}">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="menu-item">
                    <a class="menu-link @yield('accountActive')" wire:navigate href="{{ route('partner.account') }}">
                        <span class="menu-icon">
                ...
                <div class="menu-item">
                    <!--begin:Menu link--> 
                    <a class="menu-link" onclick="return confirm('Are you sure? you want to logout')" href="{{ route('partner.logout') }}">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-2 rotate-180">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">

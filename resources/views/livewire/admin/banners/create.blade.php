        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Add New Banner</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                        ...
                        <form id="kt_modal_new_target_form" enctype="multipart/form-data"  method="POST" class="form fv-plugins-bootstrap5 fv-plugins-framework" wire:submit.prevent="store()">
							...
							<div class="row g-9 my-3">
                                ...
                                <div class="col-md-6 fv-row fv-plugins-icon-container">
                                    ...
                                    @else
                                        <select  wire:model="link_id" id="link_id" class="form-control" data-control="select2">

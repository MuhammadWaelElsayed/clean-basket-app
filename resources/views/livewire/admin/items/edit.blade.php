                ...
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <form id="kt_modal_new_target_form" enctype="multipart/form-data" method="POST"
                            class="form fv-plugins-bootstrap5 fv-plugins-framework" wire:submit.prevent="updateData()">
                            @csrf
                            <!--begin::Input group-->
                                    ...
                                    <div class="mt-1">
                                        <div class="image-input image-input-outline image-input-placeholder image-input-empty image-input-empty"
                                            ...
                                            <div class="image-input-wrapper w-100px h-100px"
                                                style="background-image: url('{{ $image != null ? $image->temporaryUrl() : $itemImage }}')">
                                            </div>
...
@section('scripts')
    ...
    <script>
        VirtualSelect.init({
            ...
            maxWidth: '100%',
            selectedValue: <?= json_encode($service_id) ?>,
        });

            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <li class="breadcrumb-item text-muted">Usage Report</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h4 class="mb-0">Usage per Package</h4>
                            ...
                            <tbody>
                                @forelse ($report as $row)
                                    <tr>
                                        ...
                                        <td>{{ number_format($row['avg_credit_used'], 2) }}</td>
                                        <td>{{ number_format($row['consumption_percent'], 2) }}%</td>
                                        {{-- <td>{{ number_format($row['auto_renew_percent'], 2) }}%</td> --}}
                                    </tr>
                                @empty
                                    <tr>

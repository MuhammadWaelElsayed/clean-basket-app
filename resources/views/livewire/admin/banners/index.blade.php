    ...
    <div class="d-flex flex-column flex-column-fluid" data-select2-id="select2-data-129-xgx3">
        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <!--end::Page title-->
                <!--begin::Actions-->
                <div class="d-flex align-Banners-center gap-2 gap-lg-3">


                    {{-- <button type="button" class="btn btn-base btn-sm" data-bs-toggle="modal" data-bs-target="#kt_modal_add_bundle">Add Banners</button> --}}
                    @can('create_banner')
                        <a href=" {{ url('admin/banners/create') }}" class="btn btn-base btn-sm" wire:navigate>Add New
                            Banner</a>
                    @endcan
                    <!--end::Primary button-->
                </div>
            ...
            <div id="kt_app_content_container" class="app-container container-xxl"
                ...
                <div class="card">
                        ...
                        <div class="card-title">
                            ...
                            <form action="{{ url('admin/Banners') }}" method="get">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="position-relative d-flex align-Banners-center">
                    ...
                    <div class="card-body pt-0">
                        <!--begin::Table-->
                        <div id="kt_Banners_table_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                            <div class="table-responsive">
                                <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer"
                                    ...
                                    <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_Banners_table">
                                            Image
                                        </th>
                                    ...
                                    @foreach ($banners as $item)
                                        ...
                                        <tr class="odd">
                                            ...
                                            <td><img src="{{$item->image}}" class="w-100px" alt="" srcset=""></td>
                                            <td>

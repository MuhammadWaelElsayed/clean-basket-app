    ...
    <div class="d-flex flex-column flex-column-fluid" data-select2-id="select2-data-129-xgx3">
        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <!--end::Page title-->
                <!--begin::Actions-->
                <div class="d-flex align-Users-center gap-2 gap-lg-3">
                    <!--begin::Export-->
                    @can('export_data')
            ...
            <div id="kt_app_content_container" class="app-container container-xxl" data-select2-id="select2-data-kt_app_content_container">
                ...
                <div class="card">
                    ...
                    <div class="px-5 border-0 pt-6">
                        ...
                        <div class="card-title">
                            ...
                            <form action="{{ url('admin/users') }}" method="get">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="d-flex align-Users-center position-relative my-1">
                                            ...
                                            placeholder="Search User Name, Area.." >
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="position-relative d-flex align-Users-center">
                                            <span class="svg-icon svg-icon-2 position-absolute mx-4 mt-4" style="z-index: 1">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <input class="form-control form-control-solid  ps-12" wire:model.live.debounce.2000ms="daterange" id="daterange" autocomplete="off" placeholder="Select Date Range" autocomplete="off">
                    ...
                    <div class="card-body pt-0">
                        <!--begin::Table-->
                        <div id="kt_Users_table_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer"><div class="table-responsive"><table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="kt_Users_table">
                            <!--begin::Table head-->
                            <thead>
                                <!--begin::Table row-->
                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                    <th class="w-10px pe-2 sorting_disabled" rowspan="1" colspan="1" aria-label="" style="width: 29.8906px;">
                                       # </th>
                                    <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_Users_table">Picture</th>
                                    <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_Users_table">Name</th>
                                    <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_Users_table">Email</th>
                                    <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_Users_table">Phone</th>
                                    <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_Users_table">Area</th>
                                    <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_Users_table">Location</th>
                                    <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_Users_table">Last Order</th>
                                    <th class="min-w-75px sorting" tabindex="0" aria-controls="kt_Users_table" >Status</th>
                            ...
                            <tbody class="fw-semibold text-gray-600 fs-6">
                                ...
                                @foreach ($users as $item)
                                    ...
                                    <tr class="odd">
                                        ...
                                        <td><img src="{{$item->picture}}" class="w-50px h-50px rounded-circle" alt="user">
                                          </td>
                                        ...
                                        <td>
                                            @if ($item->address)
                                                <a href="https://maps.google.com/?q={{$item->address->lat??0}},{{$item->address->lng?? 0}}" target="_blank"
                                                class="btn btn-sm btn-base px-2">Get Location <i class="fas fa-map-marker-alt text-white"></i> </a></td>
                                            @else
                                                    --
                                            @endif
                                          <td>
                                             <span>{{$item->last_order_at??'--'}}</span>
                                        </td>
    ...
    <script>
        ...
        for (let i = 0; i < statusBtns.length; i++) {
            statusBtns[i].onclick = function(e){
                ...
                if(status==0){
                    var message="Do you want to Active this user?";
                }else{
                    var message="Do you want to In-active this user?";
                }
                e.preventDefault();
                Swal.fire({
                    // title: 'Are you sure?',

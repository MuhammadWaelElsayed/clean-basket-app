            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        <!--begin::Item-->
                        <li class="breadcrumb-service text-muted">
                        ...
                        <!--begin::Item-->
                        <li class="breadcrumb-service text-muted">
                            <a href="{{ url('admin/services') }}" class="text-muted text-hover-primary">Services</a>
                        </li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                                ...
                                <div class="col-md-6 fv-row fv-plugins-icon-container">
                                    ...
                                    <div class="mt-1"> 
                                        <div class="image-input image-input-outline image-input-placeholder image-input-empty image-input-empty" data-kt-image-input="true">
                                            ...
                                            <div class="image-input-wrapper w-100px h-100px" style="background-image: url('{{($image!=null)?$image->temporaryUrl():$serviceImage}}')"></div>

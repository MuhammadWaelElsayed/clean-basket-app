  ...
  <div class="d-flex flex-column flex-column-fluid">
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
      <div class="app-container container-xxl d-flex flex-stack">
        <h1 class="page-heading text-dark fw-bold fs-3">Create Voucher</h1>
      </div>
    </div>
        ...
        <form wire:submit.prevent="create">
          <div class="row g-3">
            <div class="col-md-6">
              ...
              <input type="text" wire:model.defer="type" class="form-control" placeholder="package" disabled>
              @error('type')<span class="text-danger">{{ $message }}</span>@enderror
            </div>
            <div class="col-md-6">
              <label class="form-label">Amount</label>
              <input type="number" step="0.01" wire:model.defer="amount" class="form-control" placeholder="Leave blank for free service">

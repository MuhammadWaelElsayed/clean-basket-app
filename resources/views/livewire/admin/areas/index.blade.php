        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Areas</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                ...
                <!--end::Page title-->
                <!--begin::Actions-->
                <div class="d-flex align-Areas-center gap-2 gap-lg-3">
                    <!--begin::Export--> 
                    {{-- <a href="{{ url('admin/Areas?export=1&'.http_build_query($_GET)) }}" class="btn  btn-sm  btn-light-primary me-3" >
                    ...
                    {{-- <button type="button" class="btn btn-base btn-sm" data-bs-toggle="modal" data-bs-target="#kt_modal_add_bundle">Add Areas</button> --}}
                    <a href=" {{ url('admin/areas/create') }}" class="btn btn-base btn-sm" >Add New Area</a>
                    <!--end::Primary button-->
                </div>
                <!--end::Actions-->
            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-title">
                            <!--begin::Search-->
                            <form  method="get"> 
                                <div class="d-flex align-Areas-center position-relative my-1">
                                    ...
                                    placeholder="Search Area Name or City.." >
                                    <div class="position-relative d-flex align-Areas-center">
                                        <!--begin::Icon-->
                    ...
                    <div class="card-body pt-0">
                        <!--begin::Table-->
                        <div id="kt_Areas_table_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer"><div class="table-responsive"><table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="kt_Areas_table">
                            <!--begin::Table head-->
                            <thead>
                                <!--begin::Table row-->
                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                    <th class="w-10px pe-2 sorting_disabled" rowspan="1" colspan="1" aria-label="" style="width: 29.8906px;">
                                       # </th>
                                    <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_Areas_table">Name</th>
                                    <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_Areas_table">City</th>
                                    <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_Areas_table">Is Serving</th>
                                    <th class="min-w-75px sorting" tabindex="0" aria-controls="kt_Areas_table" >Status</th>
                            ...
                            <tbody class="fw-semibold text-gray-600 fs-6">
                                ...
                                {{-- {{dd($item->images)}} --}}
                                    <tr class="odd">
                                        <!--begin::Checkbox-->
                                        <td>{{ ($areas->currentPage() - 1)  * $areas->count() + $loop->iteration }} </td> 
                                        {{-- @dd($item->images[0]) --}}

                                        <td>{{$item->name}} </td>
                                        <td>{{$item->city->name}} </td>
                                        <td>{{($item->is_serving==1)?'YES':'NO'}} </td>
                                        ...
                                        <td class="text-center d-flex mt-2" >
                                            <a href="{{ url('admin/areas/'.$item->id.'/edit') }}" class="btn btn-sm h-30px btn-light-primary"><i class="fas fa-pencil"></i></a>
                                            {{-- <a href="{{ url('admin/Areas/'.$item->id) }}"  class="btn btn-sm h-30px btn-light-primary"><i class="fas fa-eye"></i></a> --}}
                                            <form  method="post">
                                                {{-- @method('DELETE') @csrf  --}}

...
@section('inventoryActive','active')
    ...
    <div class="d-flex flex-column flex-column-fluid" data-select2-id="select2-data-129-xgx3">
        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0"> Inventory</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid" data-select2-id="select2-data-kt_app_content">
            ...
            <div id="kt_app_content_container" class="app-container container-xxl" data-select2-id="select2-data-kt_app_content_container">
                <div class="row mb-3">
                    <div class="col-md-3 ">
                        <div class="box bg-primary rounded p-5 border  m-1">
                            <h3 class="text-white">Total Baskets</h3>
                            <div class="row text-white">
                                <h1 class=" col-9 text-white display-6 mt-2">{{$stats['total']}}</h1>
                                <p class="col-3">
                                    <i class="fas fa-shopping-basket text-white mt-1" style="font-size:38px; opacity:0.8"></i>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="col-md-3 ">
                        <a href="{{ url('admin/requests?status=Delivered') }}" > 
                        <div class="box bg-primary rounded p-5 border  m-1">
                            <h3 class="text-white">Baskets Delivered</h3>
                            <div class="row text-white">
                                <h1 class=" col-9 text-white display-6 mt-2">{{$stats['delivered']}}</h1>
                                <p class="col-3">
                                    <i class="fas fa-check-circle text-white mt-1" style="font-size:38px; opacity:0.8"></i>
                                </p>
                            </div>
                        </div>
                        </a>
                    ...
                    <div class="col-md-3 ">
                        <div class="box bg-primary rounded p-5 border  m-1">
                            <h3 class="text-white">Available Baskets</h3>
                            <div class="row text-white">
                                <h1 class=" col-9 text-white display-6 mt-2">{{$stats['available']}}</h1>
                                <p class="col-3">
                                    <i class="fas fa-boxes text-white mt-1" style="font-size:38px; opacity:0.8"></i>
                                </p>
                            </div>
                        </div>
                        ...
                        <div id="kt_packages_table_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer"><div class="table-responsive">
                            ...
                            <thead>
                                ...
                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0 bg-light">
                                    <th class="w-50px px-2 " rowspan="1" colspan="1" aria-label="" >
                                       # </th>
                                    <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_packages_table">Desc</th>
                                    <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_packages_table">Quantity  </th>
                            ...
                            <tbody class="fw-semibold text-gray-600 fs-6">
                                ...
                                {{-- {{dd($item)}} --}}
                                    <tr class="odd">
                                        <!--begin::Checkbox-->
                                        <td class="px-2">{{ ($inventory->currentPage() - 1)  * $inventory->perPage() + $loop->iteration }} </td> 
                                        <td>{{$item->desc ?: '--'}} </td>
                                        <td>{{$item->quantity }} </td>
                ...
                <form wire:submit.prevent="saveData()" method="post">
                    <div class="modal-body">
                        <div class="mb-5 fv-row fv-plugins-icon-container">
                            ...
                            <input type="number" class="form-control form-control-solid" placeholder="Enter  Quantity" wire:model="quantity" >
                            @error('quantity') <span class="text-danger">{{$message}}</span> @enderror
                        </div>
                        <div class=" fv-row fv-plugins-icon-container">
                            <label class=" fs-6 fw-semibold mb-2"> Descripton</label>
                            <textarea wire:model="desc" class="form-control form-control-solid"  rows="3" placeholder="Write Description"></textarea>
                            @error('descripton') <span class="text-danger">{{$message}}</span> @enderror
                        </div>
                    </div>

@php
        ...
        $notifications= App\Models\VendorNotification::where(['is_read'=>0,'vendor_id'=>$user->id])->latest('id')->limit(10)->get();
@endphp
<div id="kt_app_header" class="app-header bg-gradient-right ">
    ...
    <div class="app-container container-fluid d-flex align-items-stretch justify-content-between" id="kt_app_header_container">
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0"> 
            <a href="{{ url('partner/dashboard') }}" class="d-lg-none  rounded"> 
                        ...
                        <div class="d-flex flex-column mt-5 px-2">
                            ...
                            <div class="pb-0">
                                ...
                                <div class="text-center mt-5 mb-9"> 
                                    <a href="{{ url('partner/clear-notifications') }}" class="btn btn-sm btn-base px-6" >Clear All</a>
                                </div>
                                @else
                                    <div class="text-center mt-5 mb-9"> 
                ...
                <div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="d-flex flex-column">
                                    <div class="fw-bold d-flex align-items-center fs-5">{{$user->business_name}}
                        ...
                        <div class="menu-item px-5 my-1"> 
                            <a href="{{ url('partner/account') }}" class="menu-link px-5">Account Settings</a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item--> 
                        <div class="menu-item px-5">
                            <a onclick="return confirm('Are you sure? you want to logout')" href="{{ url('partner/logout') }}" class="menu-link px-5">Logout</a>
                        </div>
                        <!--end::Menu item-->
                    </div>

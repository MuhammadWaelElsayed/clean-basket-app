                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                ...
                                <select wire:model.live="vendor_id" wire:change="selectVendor" class="form-select">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped">
                                    ...
                                    @foreach ($workingHours as $hour)
                                        <tr>
                                            <td>{{ $hour->vendor->business_name }}</td>
                                            <td>
                        ...
                        @else
                            <div class="text-center py-4">
                                ...
                                <p class="text-muted">No working hours recorded</p>
                            </div>
                        @endif
                    </div>
                </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form wire:submit.prevent="save">
                                <!-- Vendor Selection (if not editing) -->
                                @if (!$editingId)
                                    <div class="mb-3">
                                        <label for="vendor_id" class="form-label">Vendor</label>
                                        <select wire:model="vendor_id" class="form-select" required>
                                            <option value="">-- Select Vendor --</option>
                                            @foreach ($vendors as $vendor)

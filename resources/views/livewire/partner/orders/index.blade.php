                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <li class="breadcrumb-item text-muted">
                            <a href="{{ url('partner/dashboard') }}" wire:navigate class="text-muted text-hover-primary">Home</a>
                        </li>
                        <!--end::Item-->
                        <!--begin::Item-->
            ...
            <div id="kt_app_content_container" class="app-container container-xxl" data-select2-id="select2-data-kt_app_content_container">
                ...
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        <!--begin::Table-->
                        <div id="kt_Orders_table_wrapper" class="">
                            <div class="table-responsive">
                            <table class="table align-middle table-hover fs-6 gy-5 " id="kt_Orders_table">
                                <!--begin::Table head-->
                                <thead>
                                    <!--begin::Table row-->
                                    <tr class="text-start text-gray-600 fw-bold fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="text-center min-w-125px " >Actions</th></tr>
                                    <!--end::Table row-->
                                </thead>
                                <!--end::Table head-->
                                <!--begin::Table body-->
                                <tbody class="fw-semibold text-gray-600 fs-6">
                                    ...
                                    {{-- {{dd($item->user)}} --}}
                                        <tr class="odd cursor-pointer" >
                                            ...
                                            <td wire:click="gotoDetails({{$item->id}})">{{env('CURRENCY')}} {{number_format($item->grand_total)}} </td>

                                            <td wire:click="gotoDetails({{$item->id}})"><small> {{$item->created_at}} </small></td>

                                            <td wire:click="gotoDetails({{$item->id}})"><button  class=" p-0 btn btn-transparent"> <span class="badge fs-lg-7 badge-{{$statuses[$item->status]}}"> {{$item->status}} </span> </button></td>

                                            <!--begin::Action=-->
                                            <td class="text-center">
                                                @if ($item->status=='ARRIVED' )
                                                    {{-- <a href="{{ url('partner/order-items/'.$item->id) }}" class="btn btn-sm p-1 m-1 border btn-light btn-active-light-primary">
                                                        Order Items <i class="fas fa-plus fs-8"></i>
                                                    </a> --}}
                                                @endif
                                                
                                                <a href="{{ url('partner/order-details/'.$item->id) }}" class="btn btn-sm p-1 m-1 border btn-light btn-active-light-primary">
                                                    Details <i class="fas fa-eye fs-8"></i>
                                                </a>

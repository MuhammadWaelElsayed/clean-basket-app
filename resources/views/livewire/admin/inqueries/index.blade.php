...
@section('inqueriesActive','active')
        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0"> Inqueries</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted"> Inqueries</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                        ...
                        <div id="kt_packages_table_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer"><div class="table-responsive">
                            ...
                            <thead>
                                ...
                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0 bg-light">
                                    <th class="w-50px px-2 " rowspan="1" colspan="1" aria-label="" >
                                       # </th>
                                    <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_packages_table">Name </th>
                                    <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_packages_table">Email</th>
                                    <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_packages_table">Phone</th>
                                    <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_packages_table">Message</th>
                            ...
                            <tbody class="fw-semibold text-gray-600 fs-6">
                                ...
                                {{-- {{dd($item)}} --}}
                                    <tr class="odd">
                                        <!--begin::Checkbox-->
                                        <td class="px-2">{{ ($contacts->currentPage() - 1)  * $contacts->perPage() + $loop->iteration }} </td> 
                                        <td>{{$item->name}} </td>
                                        <td>{{$item->email}} </td>
                                        <td>{{$item->phone}} </td>
                                        <td>{{$item->message}} </td>

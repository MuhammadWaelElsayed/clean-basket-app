            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">Drivers</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                <!--end::Page title-->
                <!--begin::Actions-->
                <div class="d-flex align-drivers-center gap-2 gap-lg-3">
                    <!--begin::Export-->
                    ...
                    @can('drivers_map')
                        <a href="{{ route('admin.drivers.map') }}" wire:navigate class="btn  btn-sm  btn-light-dark me-3">Drivers Map</a>
                    @endcan

                    @can('create_driver')
                        <a href="{{ url('admin/drivers/create') }}" wire:navigate class="btn btn-base btn-sm">Add New
                            Driver</a>
                    @endcan
                ...
                <div class="card">
                    ...
                    <div class="mx-5 border-0 pt-6">
                        ...
                        <div class="card-title">
                            <!--begin::Search-->
                            <form action="{{ url('admin/drivers') }}" method="get">
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        <div class="d-flex align-drivers-center position-relative ">
                                    ...
                                    {{-- <div class="col-md-3 mb-3">
                                        <select wire:model="is_company" class="form-control" id="">
                                            <option value="">Filter Driver/Company</option>
                                            <option value="0">Drivers</option>
                                            <option value="1">Companies</option>
                                        </select>
                                    </div> --}}
                                    <div class="col-md-4">
                                        <div class="position-relative d-flex align-drivers-center">
                    ...
                    <div class="card-body pt-0">
                        <!--begin::Table-->
                        <div id="kt_drivers_table_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                            <div class="table-responsive">
                                <table class="table align-middle table-hover fs-6 gy-5 " id="kt_drivers_table">
                                    ...
                                    <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_drivers_table">
                                            Picture
                                        </th>
                                        <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_drivers_table">
                                            Name
                                        ...
                                        <th class="min-w-75px sorting" tabindex="0" aria-controls="kt_drivers_table">
                                            Status
                                        </th>
                                        {{-- <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_drivers_table">Is Approved</th> --}}
                                        ...
                                        <tr class="odd">
                                            ...
                                            <td>
                                                <a href="https://www.google.com/maps?q={{$item->lat}},{{$item->lng}}"
                                                   target="_blank"
                                                   class="btn btn-sm btn-light-primary mt-3">Location</a>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <p class="d-flex">
                                                    {{-- <a href="{{ url('admin/drivers/'.$item->id) }}"   wire:navigate  class="btn btn-sm h-30px btn-light-primary"><i class="fas fa-eye"></i></a> --}}
                                                    <a target="_blank" href="{{ $item->id_image }}">View ID</a>

                                                    <a target="_blank" href="{{ $item->license }}">View licence</a>

                                                    @can('update_driver')
                                                        <a href="{{ url('admin/drivers/'.$item->id.'/edit') }}"
        ...
        <script>
            ...
            for (let i = 0; i < delBtns.length; i++) {
                delBtns[i].onclick = function (e) {
                    ...
                    Swal.fire({
                        // title: 'Are you sure?',
                        title: "You want to approved/disapprove account",
                        icon: 'warning',
                        showCancelButton: true,
                        cancelButtonColor: '#5E6278',
                        // confirmButtonColor: '#d33',

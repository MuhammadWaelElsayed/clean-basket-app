        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Edit Vendor Details</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
            ...
            <div id="kt_app_content_container" class="app-container container-xxl" data-select2-id="select2-data-kt_app_content_container">
                ...
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        <!--begin::Form-->  
                        <form id="kt_modal_new_target_form" enctype="multipart/form-data"  method="POST" class="form fv-plugins-bootstrap5 fv-plugins-framework" wire:submit.prevent="update()">
                            @csrf
							<!--begin::Input group-->
							<div class="row g-9 my-3">
                                ...
                                <div class="col-md-6 fv-row fv-plugins-icon-container">
                                    ...
                                    <input type="number" class="form-control form-control-solid" placeholder="Enter Vendor phone (961xxxxxx)" wire:model="phone" >
                                ...
                                <div class="col-md-6 fv-row fv-plugins-icon-container">
                                    ...
                                    <input type="text" class="form-control form-control-solid" placeholder="Enter City" wire:model="city" >
                                ...
                                <div class="col-md-6 fv-row fv-plugins-icon-container" wire:ignore>
									<label class="required fs-6 fw-semibold mb-2">Legal Consultant:</label>
                                    <div id="arbitrators" wire:ignore></div>
                                    @error('vendor_arbitrators') <span class="text-danger">{{$message}}</span> @enderror
                                </div>
                                <div class="col-md-6 fv-row fv-plugins-icon-container" wire:ignore>
                                    <label class="required fs-6 fw-semibold mb-2">Jurisdictions:</label>
                                ...
                                @if($is_company==0)
                                    <div class="col-md-6 fv-row fv-plugins-icon-container">
                                        <label class="required fs-6 fw-semibold mb-2">Update {{__('Certificate')}} (<a target="_blank" href="{{$certificateUrl}}"> {{basename($certificateUrl)}} </a> )</label>
                                        <input type="file" wire:model="certificate" class="form-control" >
                                        @error('certificate') <span class="text-danger">{{$message}}</span> @enderror
                                    </div>
                                @endif
                                <div class="col-md-6 fv-row fv-plugins-icon-container">
									<label class="required fs-6 fw-semibold mb-2">Update License (<a target="_blank" href="{{$licenseUrl}}"> {{basename($licenseUrl)}}</a> )</label>
